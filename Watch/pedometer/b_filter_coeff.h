/**
 * @file b_filter_coeff.h
 *
 * @details Description :
 * Pedometer filter coefficients header file
 *
 * @author S. Ravindran
 * @author Texas Instruments, Inc
 * @date February, 2012
 * @version 2.0 - Original release Dec 2011
...
*
****************************************************/
#ifndef _FILTER_COEFF_b_
#define _FILTER_COEFF_b_

signed int FILTER_COEFF_b[25]={
0xF9BF,
0xFC97,
0xFF30,
0x0188,
